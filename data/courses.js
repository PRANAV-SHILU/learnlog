...
export const learningItems = [
    ...
    sources: [
      {
        ...
        link: "https://www.skillindiadigital.gov.in/courses/detail/0e985123-f259-488a-9a41-a316980ea081",
      },
    ],
  },
  {
    ...
    sources: [
      {
        type: "learnvern",
        label: "LearnVern",
        link: "http://learnvern.com/course/html5-tutorial-in-hindi",
      },
    ],
  },
  {
  ...
  // ── Competitions ──
  {
    ...
    description:
      "Achieved 1st Rank in FLASH@SSCCS-2025 — a university-level C programming competition with theory evaluation and real-time live coding. Demonstrated problem decomposition, synchronous execution thinking, and decision-making under pressure.",
    issuer: "SSCCS, Bhavnagar (Dec 2025)",
    issuerIcon: "🏆",
    sources: [
      {
        type: "college",
        label: "SSCCS Certificate",
        link: "https://www.linkedin.com/in/pranavshilu/details/certifications/1767089189664/single-media-viewer/?profileId=ACoAAEQdfM4Bjz9XMUrIjuqYXlAjrmXxwAXTjE4",
      },
    ],
  },
