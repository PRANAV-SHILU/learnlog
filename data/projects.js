...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Modern responsive app landing page — Hero, Features, dynamic Pricing toggle, Testimonials, FAQ accordion, Download CTA. Fully responsive across all breakpoints using Flexbox, CSS Grid, and Media Queries.",
  ...
  },
  {
    ...
    description:
      "Simple responsive webpage for Whitepace built following best frontend practices — clean semantic HTML5, CSS3, and fully responsive layout.",
    stack: ["HTML5", "CSS3", "Responsive Design"],
    githubLink: "https://github.com/PRANAV-SHILU/Whitepace",
